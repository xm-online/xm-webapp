...
export class HelpCommand implements Command {
    ...
    public commands: { name: CliCommands, message: string }[] = [
        ...
        { name: 'report:bundle', message: 'webpack-bundle-analyzer dist/stats.json.' },
        { name: 'compodoc', message: 'compodoc -p tsconfig.json.' },
        { name: 'get-translations', message: 'translations' },
