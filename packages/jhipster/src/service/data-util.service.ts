...
export class JhiDataUtils {
     ...
     */
    public toBase64(file: File, cb: Function): void {
     ...
     */
    public clearInputImage(entity: any, elementRef: ElementRef, field: string, fieldContentType: string, idInput: string): void {
     ...
     */
    public setFileData(event: any, entity: any, field: string, isImage: boolean): Promise<any> {
     ...
     */
    public loadFileToForm(event: Event, editForm: FormGroup, field: string, isImage: boolean): Observable<void> {
