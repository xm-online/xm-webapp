...
export class JhiAlertService {
    ...
    public success(msg: string, params?: any, position?: string): JhiAlert {
    ...
    public error(msg: string, params?: any, position?: string): JhiAlert {
        return this.addAlert(
            {
                type: 'danger',
                msg,
    ...
    public warning(msg: string, params?: any, position?: string): JhiAlert {
        return this.addAlert(
            {
                type: 'warning',
                msg,
    ...
    public info(msg: string, params?: any, position?: string): JhiAlert {
        return this.addAlert(
            {
                type: 'info',
                msg,
    ...
    public addAlert(alertOptions: JhiAlert, extAlerts: JhiAlert[]): JhiAlert {
    ...
    public closeAlert(id: number, extAlerts?: JhiAlert[]): JhiAlert[] {
    ...
    public closeAlertByIndex(index: number, thisAlerts: JhiAlert[]): JhiAlert[] {
