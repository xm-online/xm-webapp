...
import { nullSafe } from 'src/app/shared/jsf-extention/jsf-attributes-helper';
 ...
 */
import { EntityDetailDisplayMode, EntityUiConfig } from 'src/app/shared/spec/xm-ui-config-model';
