...
export { XmEventManagerService as XmEventManager, XmEventManagerService } from './src/xm-event-manager.service';
...
export { IIdpConfig, IIdpClient, IOpenIdConfig } from './src/xm-public-idp-config-model';
...
export { ContextService } from './src/context.service';
