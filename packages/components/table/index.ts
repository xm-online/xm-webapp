...
export * from './components/xm-table-control.component';
...
export * from './components/xm-table-filter-inline.component';
export * from './components/xm-table-filters-control.component';
export * from './components/xm-table-filters-control-request.component';
