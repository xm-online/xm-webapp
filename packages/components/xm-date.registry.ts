...
export const XM_DATE_ELEMENTS: XmDynamicEntry[] = [
    {
        ...
        loadChildren: () => import('@xm-ngx/components/date/xm-date.component').then(m => m.XmDate),
    },
    {
    ...
    },
    {
        ...
        loadChildren: () => import('@xm-ngx/components/date/xm-date-range-filter-control').then(m => m.DateRangeFilterControlComponent),
    },
    {
        selector: '@xm-ngx/components/datetime-control',
        loadChildren: () => import('@xm-ngx/components/date/xm-datetime-control').then(m => m.XmDatetimeControl),
    },
    {
